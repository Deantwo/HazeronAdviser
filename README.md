...
My name is Deantwo and this is my little C# program that I have been working on for a little while.
I started after seeing se5a's HazeronMapper and thought it would be fun to try my self.

What is it
==============

[b]HazeronAdviser[/b] is a simple little program that scans through all your HMails that are locally saved on your computer.
